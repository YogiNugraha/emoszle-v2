  ...
  <div class="footer-content">
    <div class="footer-extra-info">
      <div class="info-column">
        ...
        <p>
          Unduh artikel berisi panduan lengkap terkait E-Moszle
          <a href="path/ke/artikel-anda.pdf" target="_blank">di sini</a>.
        </p>
      </div>
      <div class="info-column">
        <h4>Kontak</h4>
        <p>
          Founder E-Moszle<br>
          <a href="mailto:hanaastrianur@umkuningan.ac.id">hanaastrianur@umkuningan.ac.id</a>
        </p>
      </div>
    </div>
    ...
    <div class="social-links">
      ...
      <a href="https://instagram.com/your-username" target="_blank" title="Instagram">
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24">
    ...
    <p class="copyright">
      &copy; <span id="current-year"></span> <a href="#">E-Moszle Project</a>. All Rights Reserved.
    </p>
  </div>
</footer>
